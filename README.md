...
The one-liner installer is not for unattended installations: it will ask you if you want to set a python virtual environment, then ask for the ATCO codes you're interested seeing the arrival times, the train stations as well, plus your Traveline API credentials.
